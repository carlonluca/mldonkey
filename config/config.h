...
/*
This file is a static placeholder used in dune builds. While the old
make-based build was configurable, the new dune build is not, and
everything is compiled in the final binary.
*/
...
/* Define to 1 if you have libminiupnpc & libnatpmp for port forwarding
   support. */
#define ENABLE_UPNP_NATPMP 1
