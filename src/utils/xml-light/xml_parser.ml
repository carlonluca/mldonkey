...
open Parsing;;
let _ = parse_error;;
# 1 "src/utils/xml-light/xml_parser.mly"
(*
...
*)	
  ...
  open Xml_types
# 37 "src/utils/xml-light/xml_parser.ml"
let yytransl_const = [|
  257 (* NEXT *);
  258 (* OR *);
  260 (* PCDATA *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 37 "src/utils/xml-light/xml_parser.mly"
                ( _1 )
# 128 "src/utils/xml-light/xml_parser.ml"
               : Xml_types.dtd_child))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'dtd_seq) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_op) in
    Obj.repr(
# 41 "src/utils/xml-light/xml_parser.mly"
                ( _3 _1 )
# 136 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_full_seq))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'dtd_seq) in
    Obj.repr(
# 43 "src/utils/xml-light/xml_parser.mly"
                ( _1 )
# 143 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_full_seq))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'dtd_item) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_children) in
    Obj.repr(
# 47 "src/utils/xml-light/xml_parser.mly"
                ( DTDChildren (_1 :: _3) )
# 151 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_seq))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'dtd_item) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_choice) in
    Obj.repr(
# 49 "src/utils/xml-light/xml_parser.mly"
                ( DTDChoice (_1 :: _3) )
# 159 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_seq))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_item) in
    Obj.repr(
# 51 "src/utils/xml-light/xml_parser.mly"
                ( _1 )
# 166 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_seq))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'dtd_item) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_children) in
    Obj.repr(
# 55 "src/utils/xml-light/xml_parser.mly"
                ( _1 :: _3 )
# 174 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_children))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_item) in
    Obj.repr(
# 57 "src/utils/xml-light/xml_parser.mly"
                ( [_1] )
# 181 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_children))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'dtd_item) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_choice) in
    Obj.repr(
# 61 "src/utils/xml-light/xml_parser.mly"
                ( _1 :: _3 )
# 189 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_choice))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_item) in
    Obj.repr(
# 63 "src/utils/xml-light/xml_parser.mly"
                ( [_1] )
# 196 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_choice))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_full_seq) in
    Obj.repr(
# 67 "src/utils/xml-light/xml_parser.mly"
                ( _2 )
# 203 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_item))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_member) in
    Obj.repr(
# 69 "src/utils/xml-light/xml_parser.mly"
                ( _1 )
# 210 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_item))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_op) in
    Obj.repr(
# 73 "src/utils/xml-light/xml_parser.mly"
                ( _2 (DTDTag _1) )
# 218 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_member))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_op) in
    Obj.repr(
# 75 "src/utils/xml-light/xml_parser.mly"
                ( _2 DTDPCData )
# 225 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_member))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 77 "src/utils/xml-light/xml_parser.mly"
                ( DTDTag _1 )
# 232 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_member))
; (fun __caml_parser_env ->
    Obj.repr(
# 79 "src/utils/xml-light/xml_parser.mly"
                ( DTDPCData )
# 238 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_member))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'dtd_op_item) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_op) in
    Obj.repr(
# 83 "src/utils/xml-light/xml_parser.mly"
                ( (fun x -> _2 (_1 x)) )
# 246 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_op))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'dtd_op_item) in
    Obj.repr(
# 85 "src/utils/xml-light/xml_parser.mly"
                ( _1 )
# 253 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_op))
; (fun __caml_parser_env ->
    Obj.repr(
# 89 "src/utils/xml-light/xml_parser.mly"
                ( (fun x -> DTDZeroOrMore x) )
# 259 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_op_item))
; (fun __caml_parser_env ->
    Obj.repr(
# 91 "src/utils/xml-light/xml_parser.mly"
                ( (fun x -> DTDOptional x) )
# 265 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_op_item))
; (fun __caml_parser_env ->
    Obj.repr(
# 93 "src/utils/xml-light/xml_parser.mly"
                ( (fun x -> DTDOneOrMore x) )
# 271 "src/utils/xml-light/xml_parser.ml"
               : 'dtd_op_item))
(* Entry dtd_element *)
